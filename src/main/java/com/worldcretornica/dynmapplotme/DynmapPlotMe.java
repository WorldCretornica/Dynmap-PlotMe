...
public class DynmapPlotMe extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        /* Get WorldGuard */
        Plugin plotMe = pluginManager.getPlugin("PlotMe");
        if (plotMe == null) {
            getLogger().severe("Cannot find PlotMe!");
            return;
        }

        plotme = (PlotMe_CorePlugin) plotMe;
    ...
    private static class AreaStyle {
        ...
        AreaStyle(ConfigurationSection cfg, String path, AreaStyle def) {
        ...
        AreaStyle(ConfigurationSection cfg, String path) {
